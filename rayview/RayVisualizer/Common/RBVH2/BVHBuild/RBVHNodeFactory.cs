...
{
    public class RBVHNodeFactory : NodeFactory<RBVH2Branch, RBVH2Leaf, RBVH2, float>
    {
        public static readonly RBVHNodeFactory ONLY = new RBVHNodeFactory();

        private RBVHNodeFactory() { }

        public RBVH2Branch BuildBranch(TreeNode<RBVH2Branch, RBVH2Leaf> left, TreeNode<RBVH2Branch, RBVH2Leaf> right, float pLeft, int branchCounter, int depth, Box3 boundingBox)
        {
            return new RBVH2Branch() { ID = branchCounter, BBox = boundingBox, Depth = depth, PLeft = pLeft };
        }
