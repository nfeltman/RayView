...
namespace RayVisualizer
{
    ...
    {
        public void OnRenderFrame(SceneData scene, GameWindow w, FrameEventArgs e)
        {
            Matrix4 lookat = Matrix4.LookAt(scene.Location, scene.Location + scene.ForwardVec, Vector3.Cross(scene.RightVec, scene.ForwardVec));
            ...
            foreach (RayCast c in scene.Rays[0].Rays)
            {
        ...
        public void OnUpdateFrame(SceneData scene, GameWindow w, FrameEventArgs e)
        {
