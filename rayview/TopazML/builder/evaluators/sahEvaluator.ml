...
let evaluate_split stack leftAgg rightAgg filter = (surface_area leftAgg.box) *. (float_of_int leftAgg.count) +. (surface_area rightAgg.box) *. (float_of_int rightAgg.count)
