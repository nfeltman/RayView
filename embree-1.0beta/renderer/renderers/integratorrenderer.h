...
namespace embree
{
  ...
  private:
    ...
    void renderThread();
    static void run_renderThread(size_t tid, IntegratorRenderer* This, size_t) { This->renderThread(); }

    /*! Configuration */
  private:
    int maxDepth;                  //!< Maximal recursion depth.
    bool accumulate;               //!< Whether to accumulate or overwrite the framebuffer.
